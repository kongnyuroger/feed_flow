...
<nav class="navbar">
    ...
    <div class="main-container">
                            ...
                            <?php if (isLoggedIn()): ?>
                                ...
                                <?php else: ?>
                                    ...
                                    <li class="feed-li-el"
                                        ...
                                        data-url="<?php echo htmlspecialchars($feed['feed_url']); ?>"
                                        data-name="<?php echo htmlspecialchars($feed['feed_name']); ?>">
        ...
        <!-- Footer -->
        <div class="footer">
            <footer>&copy; Latest updates 2025. All rights reserved.</footer>
        </div>
    </div>
